// It’s your birthday! You wrote a wishlist and now you’re trying to guess which gift 
// is which before you open it.
...
const guessGifts = (wishlist, presents) => {
    ...
    presents.forEach(gift => {
        wishlist.forEach(wish => {
            if(gift.size === wish.size && gift.clatters === wish.clatters && gift.weight === wish.weight)
                answer.push(wish.name)
        })
    })
    return answer
}
